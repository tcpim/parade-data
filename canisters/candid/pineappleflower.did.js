export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    bearer: IDL.Func([TokenIdentifier__4], [Result_9], ["query"]),
    ...
    metadata: IDL.Func([TokenIdentifier__3], [Result_6], ["query"]),
    ...
    salesSettings: IDL.Func([AccountIdentifier__3], [SaleSettings], ["query"]),
    salesSettlements: IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(AccountIdentifier__4, Sale))],
      ["query"]
    ),
    setMinter: IDL.Func([IDL.Principal], [], ["oneway"]),
    ...
    toAddress: IDL.Func([IDL.Text, IDL.Nat], [AccountIdentifier__3], ["query"]),
